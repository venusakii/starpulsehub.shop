      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <a href="#" className="flex items-center gap-2 group mb-4">
              ...
              <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-accent">
                StarPulseHub
              </span>
            </a>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Innovation beyond the stars. Building the future of technology.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} StarPulseHub. All rights reserved.
          </p>
